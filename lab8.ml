...
let _ = WEvent.remove_listener newswire fakeNewsId ;;
let _ = WEvent.remove_listener newswire buzzFakeId ;;
...
let receive_report_id = WEvent.add_listener newswire receive_report ;;
